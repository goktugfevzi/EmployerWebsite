...
export const getUserByIdUrl="http://localhost:5133/api/Authentication/getuserById/";
...
export const updateUserUrl="http://localhost:5133/api/Authentication/userupdate/"